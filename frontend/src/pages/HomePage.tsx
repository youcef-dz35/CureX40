        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
              ...
              <div className="lg:col-span-1">
                ...
                <p className="text-gray-300 mb-6 leading-relaxed">
                  Revolutionizing healthcare with AI-powered pharmaceutical solutions.
                  Your health, our priority, powered by cutting-edge technology.
                </p>
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 bg-curex-blue-600 rounded-lg flex items-center justify-center hover:bg-curex-blue-700 transition-colors">
                    <span className="sr-only">Facebook</span>
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M20 10C20 4.477 15.523 0 10 0S0 4.477 0 10c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V10h2.54V7.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V10h2.773l-.443 2.89h-2.33v6.988C16.343 19.128 20 14.991 20 10z" clipRule="evenodd" />
                    </svg>
                  </a>
                  <a href="#" className="w-10 h-10 bg-curex-teal-600 rounded-lg flex items-center justify-center hover:bg-curex-teal-700 transition-colors">
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li><Link to="/medications" className="text-gray-300 hover:text-white transition-colors">Browse Medications</Link></li>
                  <li><Link to="/prescriptions" className="text-gray-300 hover:text-white transition-colors">Digital Prescriptions</Link></li>
                  ...
                  <li><Link to="/digital-vault" className="text-gray-300 hover:text-white transition-colors">Digital Vault</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li><a href="#" className="text-gray-300 hover:text-white transition-colors">AI Health Consultation</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Medication Delivery</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Prescription Management</a></li>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <Phone className="h-5 w-5 text-curex-teal-400 mt-0.5 flex-shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start space-x-3">
                    <Mail className="h-5 w-5 text-curex-teal-400 mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="text-gray-300">support@curex40.com</p>
                      <p className="text-sm text-gray-400">Instant Response</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <MapPin className="h-5 w-5 text-curex-teal-400 mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="text-gray-300">123 Health Street</p>
                      <p className="text-sm text-gray-400">Medical District, MD 12345</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="py-12 border-t border-gray-800">
            <div className="max-w-2xl mx-auto text-center">
              <h3 className="text-2xl font-bold mb-4">Stay Updated with Health Insights</h3>
              <p className="text-gray-300 mb-8">
                Get the latest health tips, medication updates, and AI-powered health insights delivered to your inbox.
              </p>
              <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="flex-1 px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-curex-teal-500 focus:border-transparent"
                />
                <button
                  type="submit"
                  className="px-6 py-3 bg-gradient-to-r from-curex-teal-600 to-curex-blue-600 text-white font-semibold rounded-lg hover:from-curex-teal-700 hover:to-curex-blue-700 transition-all duration-300 transform hover:scale-105"
                >
                  Subscribe
                </button>
              </form>
          ...
          <div className="py-8 border-t border-gray-800">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-gray-400 text-sm mb-4 md:mb-0">
                © 2024 CureX40. All rights reserved. | HIPAA Compliant | FDA Approved
              </div>
