...
interface WilayaData {
  id: string;
  name: string;
  status: 'adequate' | 'low-stock' | 'critical' | 'no-data';
  pharmacies: number;
  stockLevel: number;
  lastUpdate: string;
}

// Real Algeria wilayas data with proper names and IDs
const algeriaWilayas: WilayaData[] = [
  { id: '01', name: 'Adrar', status: 'no-data', pharmacies: 3, stockLevel: 0, lastUpdate: '1 week ago' },
  { id: '02', name: 'Chlef', status: 'adequate', pharmacies: 12, stockLevel: 65, lastUpdate: '4 hours ago' },
  { id: '03', name: 'Laghouat', status: 'low-stock', pharmacies: 8, stockLevel: 35, lastUpdate: '6 hours ago' },
  { id: '04', name: 'Oum El Bouaghi', status: 'adequate', pharmacies: 10, stockLevel: 70, lastUpdate: '3 hours ago' },
  { id: '05', name: 'Batna', status: 'adequate', pharmacies: 15, stockLevel: 80, lastUpdate: '2 hours ago' },
  { id: '06', name: 'Béjaïa', status: 'low-stock', pharmacies: 14, stockLevel: 40, lastUpdate: '5 hours ago' },
  { id: '07', name: 'Biskra', status: 'adequate', pharmacies: 9, stockLevel: 60, lastUpdate: '4 hours ago' },
  { id: '08', name: 'Béchar', status: 'no-data', pharmacies: 2, stockLevel: 0, lastUpdate: '2 weeks ago' },
  { id: '09', name: 'Blida', status: 'low-stock', pharmacies: 18, stockLevel: 30, lastUpdate: '3 hours ago' },
  { id: '10', name: 'Bouira', status: 'adequate', pharmacies: 11, stockLevel: 75, lastUpdate: '2 hours ago' },
  { id: '11', name: 'Tamanrasset', status: 'no-data', pharmacies: 1, stockLevel: 0, lastUpdate: '3 weeks ago' },
  { id: '12', name: 'Tébessa', status: 'adequate', pharmacies: 7, stockLevel: 55, lastUpdate: '5 hours ago' },
  { id: '13', name: 'Tlemcen', status: 'critical', pharmacies: 6, stockLevel: 15, lastUpdate: '1 hour ago' },
  { id: '14', name: 'Tiaret', status: 'adequate', pharmacies: 8, stockLevel: 65, lastUpdate: '3 hours ago' },
  { id: '15', name: 'Tizi Ouzou', status: 'adequate', pharmacies: 16, stockLevel: 70, lastUpdate: '2 hours ago' },
  { id: '16', name: 'Alger', status: 'adequate', pharmacies: 25, stockLevel: 85, lastUpdate: '1 hour ago' },
  { id: '17', name: 'Djelfa', status: 'low-stock', pharmacies: 5, stockLevel: 25, lastUpdate: '8 hours ago' },
  { id: '18', name: 'Jijel', status: 'adequate', pharmacies: 9, stockLevel: 60, lastUpdate: '4 hours ago' },
  { id: '19', name: 'Sétif', status: 'adequate', pharmacies: 13, stockLevel: 75, lastUpdate: '2 hours ago' },
  { id: '20', name: 'Saïda', status: 'low-stock', pharmacies: 4, stockLevel: 20, lastUpdate: '12 hours ago' },
  { id: '21', name: 'Skikda', status: 'adequate', pharmacies: 10, stockLevel: 65, lastUpdate: '3 hours ago' },
  { id: '22', name: 'Sidi Bel Abbès', status: 'low-stock', pharmacies: 7, stockLevel: 35, lastUpdate: '6 hours ago' },
  { id: '23', name: 'Annaba', status: 'adequate', pharmacies: 12, stockLevel: 70, lastUpdate: '2 hours ago' },
  { id: '24', name: 'Guelma', status: 'adequate', pharmacies: 8, stockLevel: 60, lastUpdate: '4 hours ago' },
  { id: '25', name: 'Constantine', status: 'adequate', pharmacies: 14, stockLevel: 80, lastUpdate: '1 hour ago' },
  { id: '26', name: 'Médéa', status: 'adequate', pharmacies: 9, stockLevel: 55, lastUpdate: '3 hours ago' },
  { id: '27', name: 'Mostaganem', status: 'low-stock', pharmacies: 6, stockLevel: 30, lastUpdate: '7 hours ago' },
  { id: '28', name: 'M\'sila', status: 'low-stock', pharmacies: 5, stockLevel: 25, lastUpdate: '10 hours ago' },
  { id: '29', name: 'Mascara', status: 'low-stock', pharmacies: 7, stockLevel: 40, lastUpdate: '5 hours ago' },
  { id: '30', name: 'Ouargla', status: 'no-data', pharmacies: 2, stockLevel: 0, lastUpdate: '1 week ago' },
  { id: '31', name: 'Oran', status: 'low-stock', pharmacies: 20, stockLevel: 45, lastUpdate: '2 hours ago' },
  { id: '32', name: 'El Bayadh', status: 'no-data', pharmacies: 3, stockLevel: 0, lastUpdate: '2 weeks ago' },
  { id: '33', name: 'Illizi', status: 'no-data', pharmacies: 1, stockLevel: 0, lastUpdate: '1 month ago' },
  { id: '34', name: 'Bordj Bou Arreridj', status: 'adequate', pharmacies: 8, stockLevel: 60, lastUpdate: '4 hours ago' },
  { id: '35', name: 'Boumerdès', status: 'adequate', pharmacies: 11, stockLevel: 70, lastUpdate: '2 hours ago' },
  { id: '36', name: 'El Tarf', status: 'adequate', pharmacies: 6, stockLevel: 55, lastUpdate: '5 hours ago' },
  { id: '37', name: 'Tindouf', status: 'no-data', pharmacies: 1, stockLevel: 0, lastUpdate: '1 month ago' },
  { id: '38', name: 'Tissemsilt', status: 'adequate', pharmacies: 5, stockLevel: 50, lastUpdate: '6 hours ago' },
  { id: '39', name: 'El Oued', status: 'adequate', pharmacies: 4, stockLevel: 45, lastUpdate: '8 hours ago' },
  { id: '40', name: 'Khenchela', status: 'adequate', pharmacies: 6, stockLevel: 55, lastUpdate: '4 hours ago' },
  { id: '41', name: 'Souk Ahras', status: 'adequate', pharmacies: 7, stockLevel: 60, lastUpdate: '3 hours ago' },
  { id: '42', name: 'Tipaza', status: 'adequate', pharmacies: 8, stockLevel: 65, lastUpdate: '2 hours ago' },
  { id: '43', name: 'Mila', status: 'adequate', pharmacies: 9, stockLevel: 70, lastUpdate: '3 hours ago' },
  { id: '44', name: 'Aïn Defla', status: 'adequate', pharmacies: 7, stockLevel: 55, lastUpdate: '4 hours ago' },
  { id: '45', name: 'Naâma', status: 'no-data', pharmacies: 2, stockLevel: 0, lastUpdate: '2 weeks ago' },
  { id: '46', name: 'Aïn Témouchent', status: 'low-stock', pharmacies: 4, stockLevel: 25, lastUpdate: '9 hours ago' },
  { id: '47', name: 'Ghardaïa', status: 'no-data', pharmacies: 2, stockLevel: 0, lastUpdate: '1 week ago' },
  { id: '48', name: 'Relizane', status: 'low-stock', pharmacies: 5, stockLevel: 30, lastUpdate: '7 hours ago' },
  { id: '49', name: 'Timimoun', status: 'no-data', pharmacies: 1, stockLevel: 0, lastUpdate: '1 month ago' },
  { id: '50', name: 'Bordj Badji Mokhtar', status: 'no-data', pharmacies: 0, stockLevel: 0, lastUpdate: '2 weeks ago' },
  { id: '51', name: 'Ouled Djellal', status: 'adequate', pharmacies: 2, stockLevel: 50, lastUpdate: '1 day ago' },
  { id: '52', name: 'Béni Abbès', status: 'no-data', pharmacies: 1, stockLevel: 0, lastUpdate: '1 week ago' },
  { id: '53', name: 'In Salah', status: 'no-data', pharmacies: 1, stockLevel: 0, lastUpdate: '1 week ago' },
  { id: '54', name: 'In Guezzam', status: 'no-data', pharmacies: 0, stockLevel: 0, lastUpdate: '2 weeks ago' },
  { id: '55', name: 'Touggourt', status: 'adequate', pharmacies: 3, stockLevel: 60, lastUpdate: '2 days ago' },
  { id: '56', name: 'Djanet', status: 'no-data', pharmacies: 0, stockLevel: 0, lastUpdate: '1 week ago' },
  { id: '57', name: 'El M\'Ghair', status: 'adequate', pharmacies: 2, stockLevel: 55, lastUpdate: '1 day ago' },
  { id: '58', name: 'El Menia', status: 'no-data', pharmacies: 1, stockLevel: 0, lastUpdate: '1 week ago' },
];
...
export default function AlgeriaMap() {
  ...
  const handleWilayaHover = (wilaya: WilayaData, event: React.MouseEvent) => {
    setHoveredWilaya(wilaya);
    setMousePosition({ x: event.clientX, y: event.clientY });
  };

  const handleWilayaLeave = () => {
  ...
  return (
    <div className="w-full">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-green-900 dark:text-green-100">
                {algeriaWilayas.filter(w => w.status === 'adequate').length}
              </p>
              <p className="text-xs text-green-600 dark:text-green-400">Wilayas</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-yellow-900 dark:text-yellow-100">
                {algeriaWilayas.filter(w => w.status === 'low-stock').length}
              </p>
              <p className="text-xs text-yellow-600 dark:text-yellow-400">Wilayas</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-red-900 dark:text-red-100">
                {algeriaWilayas.filter(w => w.status === 'critical').length}
              </p>
              <p className="text-xs text-red-600 dark:text-red-400">Wilayas</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                {algeriaWilayas.filter(w => w.status === 'no-data').length}
              </p>
              <p className="text-xs text-gray-600 dark:text-gray-400">Wilayas</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {hoveredWilaya && (
        ...
        >
          <div className="font-semibold">{hoveredWilaya.name} ({hoveredWilaya.id})</div>
          <div className="text-xs text-gray-300">
            Status: {getStatusLabel(hoveredWilaya.status)}
          </div>
          <div className="text-xs text-gray-300">
            Pharmacies: {hoveredWilaya.pharmacies}
          </div>
          <div className="text-xs text-gray-300">
            Stock: {hoveredWilaya.stockLevel}%
          </div>
          <div className="text-xs text-gray-300">
            Updated: {hoveredWilaya.lastUpdate}
          </div>
        </div>
      )}

      {/* Complete Algeria Map with All 58 Wilayas */}
      <div className="map flex items-center justify-center m-4 w-full">
        <div className="mapdiv flex">
          ...
          >
            ...
            <a 
              title="Adrar" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '01')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '01')!, e)}
            ...
            >
              <polygon
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '01')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
            ...
            <a 
              title="Chlef" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '02')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '02')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="2"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '02')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Alger" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '16')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '16')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="16"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '16')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Oran" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '31')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '31')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="31"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '31')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            {/* Constantine (25) - Key wilaya */}
            <a 
              title="Constantine" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '25')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '25')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="25"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '25')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            {/* Tamanrasset (11) - Desert wilaya */}
            <a 
              title="Tamanrasset" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '11')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '11')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="11"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '11')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Laghouat" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '03')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '03')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="3"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '03')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              ...
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '04')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '04')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="4"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '04')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Batna" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '05')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '05')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="5"
                d="M445.635-105.596
                    ...
                    l-0.17,2.37l4.26,1.398l1.37-2.896l4.118-0.522l3.302-2.224l2.582,3.252l-1.562,2.252l1.01,1.888l-0.872,5.08l4.912,3.942
                    L445.635-105.596L445.635-105.596z"
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '05')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Béjaïa" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '06')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '06')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="6"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '06')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Biskra" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '07')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '07')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="7"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '07')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Béchar" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '08')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '08')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="8"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '08')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Blida" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '09')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '09')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="9"
                d="M304.962-191.188
                    ...
                    l-3.136-0.604l-2.074,2.928l5.986,4.212l3.018-2.174l5.786,0.408l3.136-2.354l1.342,3.014l2.96,0.016l1.736-1.934l-0.378-2.716
                    l0.946,1.912l1.466-1.192l1.386,1.396l2.318-2.308l0.166-2.762l3.26,0.538L304.962-191.188L304.962-191.188z"
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '09')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Bouira" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '10')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '10')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="10"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '10')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Tébessa" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '12')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '12')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="12"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '12')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Tlemcen" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '13')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '13')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="13"
                d="M123.968-119.174
                    ...
                    l-1.914-0.396l3.218-1.902l2.57-5.506l-0.46-1.372l0.994,0.072l-0.548-2.01l-4.75,0.542l0.866-6.388l-2.354,0.482l1.606-2.27
                    l-2.382-0.092l-1.012-3.654l2.626-4.254L123.968-119.174L123.968-119.174z"
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '13')?.status || 'critical')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Tiaret" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '14')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '14')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="14"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '14')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Tizi Ouzou" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '15')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '15')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="15"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '15')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Djelfa" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '17')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '17')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="17"
                points="382.679,-38.046
                    ...
                    382.462,-41.846 "
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '17')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Jijel" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '18')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '18')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="18"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '18')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Sétif" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '19')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '19')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="19"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '19')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Saïda" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '20')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '20')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="20"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '20')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Skikda" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '21')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '21')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="21"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '21')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              ...
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '22')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '22')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="22"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '22')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Annaba" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '23')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '23')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="23"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '23')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Guelma" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '24')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '24')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="24"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '24')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Médéa" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '26')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '26')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="26"
                d="M318.817-160.868
                    ...
                    L318.817-160.868z"
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '26')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Mostaganem" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '27')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '27')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="27"
                d="M162.14-154.198
                    ...
                    L162.14-154.198z"
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '27')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="M'Sila" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '28')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '28')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="28"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '28')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Mascara" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '29')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '29')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="29"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '29')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Ouargla" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '30')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '30')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="30"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '30')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            >
              <path
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '31')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="El Bayadh" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '32')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '32')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="32"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '32')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Illizi" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '33')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '33')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="33"
                points="625.66,376.734
                    ...
                    624.859,366.534 "
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '33')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              ...
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '34')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '34')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="34"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '34')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Boumerdès" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '35')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '35')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="35"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '35')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="El Tarf" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '36')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '36')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="36"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '36')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Tindouf" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '37')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '37')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="37"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '37')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Tissemsilt" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '38')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '38')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="38"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '38')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="El Oued" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '39')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '39')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="39"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '39')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Khenchela" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '40')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '40')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="40"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '40')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Souk Ahras" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '41')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '41')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="41"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '41')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Tipaza" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '42')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '42')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="42"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '42')?.status || 'adequate')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Mila" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '43')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '43')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="43"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '43')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Ain Defla" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '44')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '44')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="44"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '44')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Naama" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '45')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '45')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="45"
                points="170.26,-44.006
                    ...
                    "
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '45')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              ...
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '46')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '46')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="46"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '46')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Ghardaia" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '47')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '47')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="47"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '47')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Relizane" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '48')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '48')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="48"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '48')?.status || 'low-stock')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Timimoun" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '49')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '49')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="49"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '49')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Bordj Badji Mokhtar" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '50')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '50')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="50"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '50')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Ouled Djellal" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '51')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '51')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="51"
                d="M392.299-41.386
                    ...
                    L392.299-41.386z"
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '51')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Beni Abbes" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '52')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '52')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="52"
                points="
                    ...
                    "
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '52')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="In Salah" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '53')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '53')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="53"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '53')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="In Guezzam" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '54')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '54')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="54"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '54')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Touggourt" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '55')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '55')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="55"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '55')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="Djanet" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '56')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '56')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <polygon
                id="56"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '56')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="El Mghair" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '57')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '57')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="57"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '57')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
            ...
            <a 
              title="El Menia" 
              href="#" 
              onClick={() => handleWilayaClick(algeriaWilayas.find(w => w.id === '58')!)}
              onMouseEnter={(e) => handleWilayaHover(algeriaWilayas.find(w => w.id === '58')!, e)}
              onMouseLeave={handleWilayaLeave}
            >
              <path
                id="58"
                ...
                fill={getStatusColor(algeriaWilayas.find(w => w.id === '58')?.status || 'no-data')}
                stroke="#ffffff"
                strokeWidth="1"
                className="cursor-pointer hover:opacity-80 transition-all"
              />
      ...
      {selectedWilaya && (
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
          <h4 className="text-lg font-semibold text-blue-900 dark:text-blue-100 mb-2">
            {selectedWilaya.name} (Wilaya {selectedWilaya.id})
          </h4>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            <div>
              <span className="font-medium text-blue-800 dark:text-blue-200">Status:</span>
              <p className="text-blue-700 dark:text-blue-300">{getStatusLabel(selectedWilaya.status)}</p>
            </div>
            <div>
              <span className="font-medium text-blue-800 dark:text-blue-200">Pharmacies:</span>
              <p className="text-blue-700 dark:text-blue-300">{selectedWilaya.pharmacies}</p>
            </div>
            <div>
              <span className="font-medium text-blue-800 dark:text-blue-200">Stock Level:</span>
              <p className="text-blue-700 dark:text-blue-300">{selectedWilaya.stockLevel}%</p>
            </div>
            <div>
              <span className="font-medium text-blue-800 dark:text-blue-200">Last Update:</span>
              <p className="text-blue-700 dark:text-blue-300">{selectedWilaya.lastUpdate}</p>
            </div>
          </div>
        </div>
      )}
